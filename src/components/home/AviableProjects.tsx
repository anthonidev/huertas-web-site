  ...
  return (
    <main className='bg-pattern ' id='proyectos-disponibles'>
      <section className=' mx-auto flex min-h-screen max-w-7xl flex-col  justify-evenly bg-cover bg-center px-4 sm:px-6 lg:px-8'>
        <header className='flex w-72 flex-col items-start border-b-[10px] border-pri-200 pt-20'>
          <h2 className='mt-2  text-start text-6xl font-extrabold uppercase text-sec-100 '>
            PROYECTOS
