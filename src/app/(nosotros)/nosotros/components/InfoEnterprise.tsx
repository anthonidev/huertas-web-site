'use client';
import { MissionIcon, VisionIcon, YearExpIcon } from '@/components/icons/Icons';
    ...
    >
      <div className="flex h-full flex-col items-center justify-center bg-gradient-to-r from-pri to-sec py-28 opacity-85 md:flex-row md:items-stretch md:space-x-10">
        <Fade direction="left">
          ...
          <p className="max-w-[16rem] text-white">
            <strong>Brindamos soluciones inmobiliarias</strong> personalizadas que generan valor,
            contribuyendo al desarrollo de nuestra ciudad con propiedades de alta rentabilidad y
      ...
      >
        <Fade direction="right">
          ...
          <p className="max-w-[16rem] text-white">
            Ser la referencia líder en el <strong>mercado inmobiliario peruano,</strong> destacando
            por un servicio excelente y relaciones confiables, impulsando el progreso en nuestra
            comunidad.
          </p>
        </Fade>
      </div>
      ...
      >
        <Fade direction="left">
          ...
          <p className="max-w-[16rem] text-white">
            En el sector inmobiliario en Lima, hemos construido una sólida reputación como
            referentes confiables,{' '}
            <strong>nuestras relaciones basadas en la ética y la transparencia </strong> han sido
            clave para generar familias satisfechas.
          </p>
        </Fade>
      </div>
